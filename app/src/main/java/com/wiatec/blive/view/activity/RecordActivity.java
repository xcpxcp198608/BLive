...
public class RecordActivity extends Activity {
    ...
    private final class SurceCallBack implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            _iDegrees = getDisplayOrientation(getDisplayRotation(), 0);
            if (_mCamera != null) {
                InitCamera();
                return;
            }
    ...
    private void InitAll() {
        ...
        _mSurfaceView = (SurfaceView) this.findViewById(R.id.surfaceView);
        ...
        InitAudioRecord();
        _SwitchCameraBtn = (ImageButton) findViewById(R.id.ibtSwitchCamera);
